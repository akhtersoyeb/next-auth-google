  ...
  return (
    <>
      ...
      <main className='grid grid-cols-2 overflow-x-hidden'>
        ...
        <div className='min-h-screen flex flex-col items-center justify-center -mt-20 space-y-20'>
          ...
          {status !== "loading" && (
            <div>
              <div>
                {!session ? (
                  <button
                    className='flex items-center space-x-2 border border-black px-4 py-2 rounded-lg bg-white text-gray-800 transition duration-200 hover:bg-gray-800 hover:text-white'
                    onClick={() => signIn()}
                  >
                  ...
                  >
                    ...
                    <span><ArrowRightOnRectangleIcon className='w-5 h-5' /></span>
                  </button>
                )}
